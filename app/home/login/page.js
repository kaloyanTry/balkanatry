...
export default function Page() {
  return (
    <main className='flex flex-col mx-auto items-center w-full h-screen justify-center'>
      <h1 className='text-6xl max-sm:2xl px-2 font-semibold text-primary-300 text-center'>
